...
<connection-fields>
    <field default-value="{{CLASS}}" editable="false" value-type="string" category="endpoint" label="@string/server_prompt/" name="server"/>
    <field default-value="{{AUTH}}" editable="false" value-type="string" category="authentication" label="Authentication" name="authentication"/>
